...
import 'package:notes_app_2/auth/register.dart';
import 'package:notes_app_2/notes/get_notes.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void validateInput() {
    setState(() {
      isButtonDisabled = !(username.text.isNotEmpty && password.text.isNotEmpty);
    });
  }
                ...
                child: isLoading
                    ...
                    : Padding(
                        ...
                        child: Text(
                          'Masuk',
                          style: TextStyle(
                            color: isButtonDisabled ? Colors.black12 : Colors.black,
                          ),
                        ),
                      ),
              ),
